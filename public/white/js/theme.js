...
demo = {
    ...
    initDashboardPageCharts: function () {
        ...
        Livewire.on("loadCharts", function (wdata) {
            ...
            var c2 = wdata.c2;
            var c2_questions = Object.keys(c2);
            // console.log(c2_questions);
            var options = [];
            for (let i = 0; i < c2_questions.length; i++) {
                // console.log(c2[c2_questions[i]]);
                // var optionKey = Object.keys(c2)[i];
                options.push(c2[c2_questions[i]]);
            }
            // console.log(options);
                    ...
                    datasets: [
                        {
                            ...
                            data: Object.values(options[0]),
                        },
                    ],
                },
            });
            // console.log(wdata.c2.length);
            for (let i = 0; i < c2_questions.length; i++) {
                $(`#c2-${i}`).click(function () {
                    var data = chart_2.config.data;
                    data.datasets[0].data = Object.values(options[i]);
                    data.labels = Object.keys(options[i]);
                    chart_2.update();
                });
            }
            // $("#c2-1").click(function () {
            //     var chart_data = Object.values(wdata.c2.toilet);
            //     var data = chart_2.config.data;
            //     data.datasets[0].data = chart_data;
            //     data.labels = Object.keys(wdata.c2.toilet);
            //     chart_2.update();
            // });

            // $("#c2-2").click(function () {
            //     var chart_data = Object.values(wdata.c2.animals);
            //     var data = chart_2.config.data;
            //     data.datasets[0].data = chart_data;
            //     data.labels = Object.keys(wdata.c2.animals);
            //     chart_2.update();
            // });
            // $("#c2-3").click(function () {
            //     var chart_data = Object.values(wdata.c2.soap);
            //     var data = chart_2.config.data;
            //     data.datasets[0].data = chart_data;
            //     data.labels = Object.keys(wdata.c2.soap);
            //     chart_2.update();
            // });
            // var c2data = {
            ...
            var c4 = wdata.c4;
            var c4_questions = Object.keys(c4);
            // console.log(c4_questions);
            var options = [];
            for (let i = 0; i < c4_questions.length; i++) {
                // console.log(c4[c4_questions[i]]);
                // var optionKey = Object.keys(c4)[i];
                options.push(c4[c4_questions[i]]);
            }
            ...
            var c3 = wdata.c3;
            var c3_questions = Object.keys(c3);
            // console.log(c3_questions);
            var options = [];
            for (let i = 0; i < c3_questions.length; i++) {
                // console.log(c3[c3_questions[i]]);
                // var optionKey = Object.keys(c3)[i];
                options.push(c3[c3_questions[i]]);
            }
            // console.log(options);
